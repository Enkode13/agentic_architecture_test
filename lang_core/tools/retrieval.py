...
from lang_core.rag_core.vectordb import vector_store
...
def make_retrieval_tool(retrieve):
    @tool(name_or_callable="retrieval")
    def retrieval_tool(query: str):
        """RAG retrieval tool for context"""
        return retrieve.hybrid_search(query)
